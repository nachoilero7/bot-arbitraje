...
class OrderBookImbalanceSignal(BaseSignal):
    ...
    def detect(self, markets: list[dict], prices: dict = None) -> list[Opportunity]:
        ...
        for market in top_markets:
            ...
            # es estructural (siempre hay mas compradores que vendedores) y no es se√±al real.
            ...
            # Ventana dinamica: max(3%, mitad del spread) ó captura depth real en mercados con spread amplio
